...
run_task_with_fixture() {
  ...
  CLAUDE_PROJECT_DIR="$scratch" PI_STUB_ARGS_FILE="$argsout" \
...
PI_STUB_ARGS_FILE="$args" node "$COMPANION" task "do thing" --json --timeout 30000 > "$scratch/task.json"
